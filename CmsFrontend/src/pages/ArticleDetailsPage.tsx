    ...
    return (
        <article className="max-w-3xl mx-auto px-6 py-12">
            ...
            <header className="mb-10 border-b border-[var(--border)] pb-8">
                <h1 className="text-4xl font-bold text-[var(--text)] mb-4 tracking-tight leading-tight">
                    {article.title}
                </h1>
            ...
            <div
                className="rich-text-content leading-relaxed text-[var(--text)] text-lg space-y-4"
