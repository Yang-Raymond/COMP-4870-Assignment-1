        ...
        <div className="container">
            ...
            <div className="mt-12 recent-wrap">
                <div className="section-header">
                    <div>
                        <h2 className="text-2xl font-extrabold tracking-tight">Recent Articles</h2>
                        <p className="section-subtext">The latest posts added to Mini-CMS.</p>
                    </div>
                </div>
                ...
                <div className="grid-3 recent-grid">
                        ...
                        recent.map((a) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <p className="article-excerpt">{short || "No preview available."}</p>
                    ...
                    {!loading && recent.length === 0 && !errorMsg && (
                        <div className="card p-6" style={{ gridColumn: "1 / -1" }}>
                            ...
                            <Link to="/articles" className="btn-primary" style={{ marginTop: 12 }}>
                                Browse Articles
                            </Link>
                        </div>
                    )}
                ...
                <div className="recent-decor" aria-hidden="true">
                    <img className="recent-mountains" src="/images/mountains.png" alt="" />
