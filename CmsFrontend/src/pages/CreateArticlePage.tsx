    ...
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
        <div className="flex items-end justify-between gap-4">
          ...
          <span className="rounded-full border border-(--brand-aqua) bg-(--brand-cream) px-3 py-1 text-sm font-semibold text-slate-800">
            Admin
          </span>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white shadow-sm p-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              className="rounded-xl bg-(--brand-pink) px-5 py-2.5 font-semibold text-white shadow-sm hover:opacity-90 transition"
            >
              Create Article
            </button>
            ...
            <button
              ...
              className="rounded-xl border border-(--border) bg-white px-5 py-2.5 font-semibold text-slate-700 hover:bg-slate-50 transition"
            >
              Cancel
            </button>
          </div>
